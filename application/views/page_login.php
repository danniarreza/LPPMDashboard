...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url('LoginController') ?>"><img src="<?php echo base_url() ?>assets/image/logolppm.jpg"></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start</p>

    <form action="<?php echo site_url('LoginController/do_login') ?>" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="pesan" style="text-align: center; color: red;"><?php if (isset($error)) {
            echo $error;
          } ?></div>
      </div>
      <div class="row">
