      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              <?php $bil=1; foreach ($user->result() as $key) { ?>
              <tr>
                ...
                <td style="text-align: center;"><?php echo $key->JENIS_KELAMIN; ?></td>
                <td style="text-align: center;"><?php echo date('d-m-Y', strtotime($key->TANGGAL_LAHIR)); ?></td>
                <td style="text-align: center;"><?php echo $key->NO_TELP; ?></td>
                ...
                <td style="text-align: center;"><a href="<?php echo site_url('AdminController/form_edit_user/'.$key->id) ?>" class="btn btn-warning">Edit</a></td>
                <td style="text-align: center;"><a href="<?php echo site_url('AdminController/delete_user/'.$key->id) ?>" class="btn btn-danger">Delete</a></td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
