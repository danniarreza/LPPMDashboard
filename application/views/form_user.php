  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-danger">
        ...
        <!-- /.box-header -->
        <form role="form" name="reservationaddform" action="<?php echo site_url('AdminController/userAddHandler');?>" method ="post" enctype="multipart/form-data">
          <div class="box-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Username</label>
                  <input type="text" class="form-control" name="username" id="eventname" placeholder="Masukkan Username">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="date" name="TL" class="form-control pull-right">
                  </div>
                </div>
              </div>
              <!-- /.col -->
              ...
              <div class="form-group">
                ...
                <input type="text" name="ket" class="form-control" placeholder="Masukkan Info Tambahan">
              </div>
              <div class="form-group">
