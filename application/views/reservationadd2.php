      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="roomloanform" action="<?php echo site_url('RoomLoanController/RoomLoanAddHandler');?>" method ="post">
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Pemohon</label>
                    <input type="text" class="form-control my-colorpicker1" name="applicantname" id="exampleInputEmail1" placeholder="Masukkan Nama Pemohon">
                  </div>
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="roomloanform" action="<?php echo site_url('RoomLoanController/RoomLoanAddHandler');?>" method ="post">
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Keperluan Acara</label>
                    <input type="text" class="form-control" name="eventintention" id="exampleInputEmail1" placeholder="Masukkan Keperluan Acara">
                  </div>
 ...
 <script>
  $(function () {
    ...
    $('#reservationtime').daterangepicker({ timePicker: true, timePickerIncrement: 10, locale:{format: 'DD/MM/YYYY h:mm A'} })
